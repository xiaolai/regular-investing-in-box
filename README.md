...
别看定投策略看起来只有一招一式，但，定投者正是因为他们只有那一招一式而已，所以才能避开所有陷阱。定投者因为必须长期持有，所以他们也只能投资最优标的。非定投者不一样，首先，他们就是没有办法理解长期的优势；更为重要的是，他们招式太多（或者以为自己可以动用的招式很多），也因此常常出错 —— 过后总是发现自己其实是在错误的地方用了错误的招式。
