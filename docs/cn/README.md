...
> 注：BOX 的组成成份，在 2021 年 1 月 19 日进行了调整，其中含有成份包括：BTC、ETH、EOS、DOT、UNI、MOB，以及 XIN。虽然过去我一直认为以太坊有一定的缺陷，但，不得不承认以太坊生态在两个周期之后依然是发展程度相对来看最高的。（ —— 此注释于 *2021 年 1 月* 补充。）
...
> 注：发行奥德赛的计划因存在法律障碍当前无法完美解决而暂缓执行 —— 但并没有放弃，时机成熟之时会再次重启。（ —— 此注释于 *2020 年 11 月* 补充。）
...
BOX，很简单，就是**锚定“一揽子主流区块链资产投资标的”的区块链凭证**（Token）。它的成份如下：
...
#### 1.2. BOX 的优势
 ...
 [BOX](https://b.watch)的成份选择与配置，遵循以下几个原则。
...
现在这个 [BOX](https://b.watch) 的成份选择就是与区块链技术发展的内在逻辑所契合的。
...
**注意**：5:4:1 是启动时美元市值的比例，随着时间的推移，这个比例无法固定。事实上固定的是成份构成：
